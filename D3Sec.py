...
# Load the data
file_path = r"C:\Users\lenovo\Downloads\FEES\B.Tech\3rd Year\Section - D.xlsx"
...
# Create a line chart for Academic Paid Fees, Hostel Paid Fees, and Transportation Paid Fees
fig_line = go.Figure()

fig_line.add_trace(go.Scatter(x=df['Name'], y=df['Academic Fees Paid'], mode='lines', name='Academic Fees Paid', line=dict(color='rgb(55, 83, 109)')))
fig_line.add_trace(go.Scatter(x=df['Name'], y=df['Hostel Fees Paid'], mode='lines', name='Hostel Fees Paid', line=dict(color='rgb(26, 118, 255)')))
fig_line.add_trace(go.Scatter(x=df['Name'], y=df['Transportation Fees Paid'], mode='lines', name='Transportation Fees Paid', line=dict(color='red')))

# Update layout
fig_line.update_layout(title='Paid Fees Line Chart',
